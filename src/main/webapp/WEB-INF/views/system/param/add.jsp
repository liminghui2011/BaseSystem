...
<div id="accordion" class="accordion">
	<div class="accordion-group">
		<div class="accordion-heading">
			<div class="title">系统管理 > 参数管理 > 新增参数</div>
		</div>
								...
								<tbody id="pi">
									<c:forEach items="${PARAM.items}" var="item" varStatus="vs">
										<tr>
											...
											<td>
												<a href="#" class="add btn btn-link" title="">添加</a>
												<a href="#" class="remove btn btn-link" title="ssssss">删除</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
...
$('.add').live('click',function(){
	...
	var html = '<tr>';
		...
		html +='<td><a href="#" class="add btn btn-link">添加</a><a href="#" class="remove btn-link">删除</a></td>';
		html +='</tr>';
